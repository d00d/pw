...
App.P3Route = Ember.Route.extend ({
	model: function() {
		return ['AVP','MUR','CCI','PSA','GSK','VGR','JNJ','CALM','T','BA','O','XOM','NAT','GEO','RAI','AINV','ARCC','PM','MAIN','WMB','HCN','MO','GD','DUK','OAK','EWS','PICK','WY','FXI','QCOM','TNH','MFA','OXY','GILD','WEC','SUI','AMZN','GOOG','CVX','VZ','CAT','PFE','SWKS','ALS.TO','MRVL','CRAY','KKR'];
	}
});
...
App.P7Route = Ember.Route.extend ({
	model: function() {
		return ['AA-B','ALS.TO','AFL','ABBV','BAX','BXLT','AMZN','ARI','AXS','BMY','CSCO','CAT','CALM','DEO','DIS','EWS','ELNK','FB','GE','GILD','GOOG','IPHYF','MFA','NGPHF','NKE','NUV','PEP','TGT','TNH','VZ','WEC','XLU'];
	}
});
